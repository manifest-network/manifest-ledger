...
import (
	...
	"github.com/liftedinit/manifest-ledger/x/mint/keeper"
	minttestutil "github.com/liftedinit/manifest-ledger/x/mint/testutil"
	"github.com/liftedinit/manifest-ledger/x/mint/types"
)
...
func (s *IntegrationTestSuite) TestAliasFunctions() {
	...
	tokenSupply := s.mintKeeper.BankTokenSupply(s.ctx, "umfx") // TODO:
