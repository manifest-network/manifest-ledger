...
func (m *MockBankKeeper) SupplyOf(ctx context.Context, denom string) types.Coin {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SupplyOf", ctx, denom)
	ret0, _ := ret[0].(types.Coin)
	return ret0
}

// SupplyOf indicates an expected call of SupplyOf.
func (mr *MockBankKeeperMockRecorder) SupplyOf(ctx, denom interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SupplyOf", reflect.TypeOf((*MockBankKeeper)(nil).SupplyOf), ctx, denom)
}
