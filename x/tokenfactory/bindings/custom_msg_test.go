...
func executeCustom(t *testing.T, ctx sdk.Context, app *app.ManifestApp, contract sdk.AccAddress, sender sdk.AccAddress, msg bindings.TokenFactoryMsg, funds sdk.Coin) error { //nolint:unparam // funds is always nil but could change in the future.
