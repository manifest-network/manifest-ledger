...
func (suite *KeeperTestSuite) TestGenesis() {
	genesisState := types.GenesisState{
		FactoryDenoms: []types.GenesisDenom{
			{
				Denom: "factory/manifest1t7egva48prqmzl59x5ngv4zx0dtrwewcvz09h0/bitcoin",
				AuthorityMetadata: types.DenomAuthorityMetadata{
					Admin: "manifest1t7egva48prqmzl59x5ngv4zx0dtrwewcvz09h0",
				},
			},
			{
				Denom: "factory/manifest1t7egva48prqmzl59x5ngv4zx0dtrwewcvz09h0/diff-admin",
				AuthorityMetadata: types.DenomAuthorityMetadata{
					Admin: "manifest15czt5nhlnvayqq37xun9s9yus0d6y26d8uh5qf",
				},
			},
			{
				Denom: "factory/manifest1t7egva48prqmzl59x5ngv4zx0dtrwewcvz09h0/litecoin",
				AuthorityMetadata: types.DenomAuthorityMetadata{
					Admin: "manifest1t7egva48prqmzl59x5ngv4zx0dtrwewcvz09h0",
				},
			},
