...
const (
	Msg_SetWithdrawAddress_FullMethodName          = "/manifest.distribution.v1beta1.Msg/SetWithdrawAddress"
	Msg_WithdrawDelegatorReward_FullMethodName     = "/manifest.distribution.v1beta1.Msg/WithdrawDelegatorReward"
	Msg_WithdrawValidatorCommission_FullMethodName = "/manifest.distribution.v1beta1.Msg/WithdrawValidatorCommission"
	Msg_FundCommunityPool_FullMethodName           = "/manifest.distribution.v1beta1.Msg/FundCommunityPool"
	Msg_UpdateParams_FullMethodName                = "/manifest.distribution.v1beta1.Msg/UpdateParams"
	Msg_CommunityPoolSpend_FullMethodName          = "/manifest.distribution.v1beta1.Msg/CommunityPoolSpend"
	Msg_DepositValidatorRewardsPool_FullMethodName = "/manifest.distribution.v1beta1.Msg/DepositValidatorRewardsPool"
)
