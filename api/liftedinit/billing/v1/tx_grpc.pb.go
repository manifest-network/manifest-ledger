...
const (
	...
	Msg_SetLeaseCustomDomain_FullMethodName = "/liftedinit.billing.v1.Msg/SetLeaseCustomDomain"
)
...
func (c *msgClient) SetLeaseCustomDomain(ctx context.Context, in *MsgSetLeaseCustomDomain, opts ...grpc.CallOption) (*MsgSetLeaseCustomDomainResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_SetLeaseCustomDomain_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedMsgServer) SetLeaseCustomDomain(context.Context, *MsgSetLeaseCustomDomain) (*MsgSetLeaseCustomDomainResponse, error) {
...
func _Msg_SetLeaseCustomDomain_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Msg_SetLeaseCustomDomain_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
